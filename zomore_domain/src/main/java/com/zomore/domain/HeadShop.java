...
public class HeadShop implements Serializable {
    ...
    private Long shopId;
    private Multiple multiple;//关联总部
    private Integer activeDay;//活跃天数
    private String contact;//联系人
    private String remark;//备注
    private String adminAccount;//管理员账号
    private String sharedmemberid;//共享会员设置Id

    public String getSharedmemberid() {
        return sharedmemberid;
    }

    public void setSharedmemberid(String sharedmemberid) {
    ...
    public Multiple getMultiple() { return multiple; }

    public void setMultiple(Multiple multiple) { this.multiple = multiple; }
