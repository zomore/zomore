...
public class MarketingRepurchase implements Serializable {
    ...
    public Integer getReperchaseNum() {
        return reperchaseNum;
    }

    public void setReperchaseNum(Integer reperchaseNum) {
        this.reperchaseNum = reperchaseNum;
    }

    public String getScopeSelect() {
        return ScopeSelect;
    }

    public void setScopeSelect(String scopeSelect) {
