        ...
        <ul class="sidebar-menu do-nicescrol">
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="${pageContext.request.contextPath}/headShop/findByRole2.do?role=2"><i class="zmdi zmdi-star-outline"></i>直营店管理</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/headShop/findByRole3.do?role=3"><i class="zmdi zmdi-star-outline"></i> 加盟店</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/headShop/findByRole3.do?role=4"><i class="zmdi zmdi-star-outline"></i>单店管理</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/headShop/findAll.do"><i class="zmdi zmdi-star-outline"></i> 查询所有</a>
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="card-body" style="position: relative;">
                                                <div class="card-title text-dark">新增管理员页面
                                                    <form action="${pageContext.request.contextPath}/headShop/save.do" method="get">
                                                        <table>
                                                            <tr>
            ...
            <table class="table table-light table-striped shadow-light">
                ...
                <c:forEach items="${headShop}" var="head">
                    <tr>
                        ...
                        <td>${head.roleStr}</td>
                        <td><a href="${pageContext.request.contextPath}/headShop/findShopById.do?headId=${head.headId}" class="btn bg-olive btn-xs">修改</a></td>
