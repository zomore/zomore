                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                <div class="col-sm-5 col-sm-5" style="width: 590px;">
                                ...
                                <form action="${basePath}zomoreShoppingGuide/searchByCondent.do" method="post">
                                    <div class="col-sm-2 col-sm-2" style="width: 90px;">
                                    ...
                                    <div class="col-sm-3 col-sm-3" style="width: 175px;">
                        ...
                        <table id="demo-custom-toolbar" data-toggle="table" class="table-bordered ">
                            ...
                            <tr>
                                ...
                                <th data-field="num" data-align="center" data-sortable="true" data-formatter="dateFormatter">编号</th>
                                <th data-field="name" data-align="center" data-sorter="priceSorter">
                                    姓名
                                </th>
                                <th data-field="phone" data-align="center" data-sortable="true"
                                    data-sorter="statusFormatter">电话
                                </th>
                                <th data-field="a" data-align="center" data-sortable="true">销售提成</th>
                                <th data-field="b" data-align="center" data-sortable="true" data-formatter="dateFormatter">指定提成</th>
                                <th data-field="c" data-align="center" data-sortable="true" data-sorter="priceSorter">
                                    充值提成
                                </th>
...
<script type="text/javascript">
    var page = new Paging();
    var url = "${basePath}zomoreShoppingGuide/listAjax.do";
    //jquery插件的写法
    $('#pageToolbar').Paging({
        //每页显示多少条
        ...
        changePagesize: function (size, pagecount, count) {
            ...
            if (state != "" || condent != "") {
                url = "${basePath}zomoreShoppingGuide/selectByCondentAjax.do?state=" + state + "&condent=" + condent;
            }
            //修改每页显示条数
            $.ajax({
                type: "POST",
                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < msg.items.length; i++) {
                        tr = " <tr>\n" +
                            ...
                            "                                <td>" + msg.items[i].shoppingGuideMeno + "</td>\n" +
...
<!-- END wrapper -->
<!-- 添加技师导购弹窗 -->
<form id="saveNewForm" action="${basePath}zomoreShoppingGuide/add.do" method="post">
        ...
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="full-width-modalLabel">新增技师导购资料</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="switchery-demo">
                                <input type="checkbox" id="isuser1" checked data-plugin="switchery" data-color="#34d3eb"
                                       name="isuser"
                                       data-size="small"/>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1"><font style="color:red;">*<font></div>
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideId" name="shoppingGuideId" type="text"
                                       placeholder="">
                            </div>
                            </br>
                            <div class="col-lg-1"><font style="color:red;">*<font></div>
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideName" name="shoppingGuideName" type="text"
                                       placeholder="">
                            </div>
                            </br>
                            <div class="col-lg-1"><font style="color:red;">*<font></div>
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuidePhone" name="shoppingGuidePhone"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideSale" name="shoppingGuideSale" type="text"
                                       placeholder="">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" id="shoppingGuideAppoint" name="shoppingGuideAppoint"
                                   type="text" placeholder="">
                            <span class="input-group-addon"
                                  style="background-color: #ffffff;border: 1px solid #ffffff !important;">%</span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideRecharge" name="shoppingGuideRecharge"
                                       type="text" placeholder="">
                                <span class="input-group-addon"
                                      style="background-color: #ffffff;border: 1px solid #ffffff !important;">%</span>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideSubcard" name="shoppingGuideSubcard"
                                       type="text" placeholder="">
                                <span class="input-group-addon"
                                      style="background-color: #ffffff;border: 1px solid #ffffff !important;">%</span>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                ...
                                <input class="form-control" id="shoppingGuideShoppingcar"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group no-margin" style="color: black;">
                                <label class="control-label">备注</label>
                                <textarea class="form-control autogrow" id="shoppingGuideMeno" name="shoppingGuideMeno"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-white waves-effect" onclick="saveNewGuide()"> 保存</button>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal --><!-- /.modal -->
            </div><!-- /.modal-dialog -->
        </div><!-- /.modal --><!-- /.modal -->
    ...
    <div id="zomore-call1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="full-width-modalLabel"
        ...
        <div class="modal-dialog modal-full">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="full-width-modalLabel1">修改技师导购资料</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <label class="control-label" style="color: black;">状态</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="switchery-demo">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group no-margin">
                                <label class="control-label" style="color: black;">备注</label>
