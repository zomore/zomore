package com.zomore.controller.ClientDisp;
...
public class ClientDisplay {
  ...
  /*
        *//*System.out.println(port+baudRate+displayRate+data+state+"12345678999999999999999999999");*//*
       *//* if (args != null) {
        ...
        Map map = new HashMap();
        map.put(PARAM_PORT_STR, port);//端口号
        map.put(PARAM_BAUD_RATE_STR, baudRate);//波特率
        map.put(PARAM_DISPLAY_RATE_STR, displayRate);//波特率与显示屏的波特设置。默认0
        map.put(PARAM_DATA_STR, data);//需要显示的字符串
