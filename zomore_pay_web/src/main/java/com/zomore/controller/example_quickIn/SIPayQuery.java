...
public class SIPayQuery {
	...
	public static void main(String[] args)  { 
		System.out.println("支付订单查询API===服务器端返回res====="+Main_QuickIn.requestAsPost(SIPayQuery.getReqparas(),ComConstant_QuickIn.SERVICEURL_NEWSI_PAY_QUERY));
	}
}
