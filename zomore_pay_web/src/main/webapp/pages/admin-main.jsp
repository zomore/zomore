...
<!--===================================================-->
                 ...
                 <div class="col-sm-8" style="margin-bottom: 10px;">
                   ...
                   <!-- Full width modal -->
                   <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">新增管理员</button>
                      ...
                      <!-- Small modal -->
                       <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal1">高级搜索</button>
									...
									<table id="demo-custom-toolbar"  data-toggle="table" class="table-bordered table table-hover">
										...
										<tbody>
                                        <c:forEach items="${adminList}" var="superAdmin">
                                            <tr>
                                                <td></td>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/superAdmin/findAdminById.do?adminId=${superAdmin.adminId}" class="btn bg-olive btn-xs" <%--data-target="#con-close-modal1"  data-toggle="modal"--%>>修改</a></td>
                                            </tr>
                                        </c:forEach>
										</tbody>
									</table>
                            ...
                            <div class="modal-body"> 
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                   ...
                                   <div class="col-md-5">
                                    <div class="input-group">
                                      <span class="input-group-addon">管理员级别:</span>
                                    ...
                                    <div class="col-md-11">
                                     <div class="input-group">
                                      <span class="input-group-addon">创建日期:</span>
                                         <input class="form-control" type="date" name="createTime" id="createTime" placeholder="请输入创建日期">
                                    </div>
                                   </div> 
                                  </div></br>
                                <div style="border-bottom: 2px dashed #e5e5e5;"></div></br>
...
<!-- ============================================================== -->
        <!-- 修改商品资料弹窗 -->
        <!-- ============================================================== -->
        <form action="${pageContext.request.contextPath}/superAdmin/updateAdminById.do?adminId=${requestScope.admin.adminId}" method="get">
