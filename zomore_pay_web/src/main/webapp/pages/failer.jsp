...
<html>
	<head>
		...
		<meta http-equiv="refresh" content="2;url=${basePath}pages/login.jsp" />
	...
	<body>
		...
		<div class="sk-main">
				<div onclick="on()" class="col-lg-12 col-md-12 col-sm-12" style="text-align: center;margin-top: 13%;">
				    <i class="iconfont icon-icon-test" style="font-size:200px; color:#0094D9"></i></br>
			        <font>登录失败了！请重新登录！</font>
			        <font>将会在2秒后自动回到登录</font>
			        <input type="email" id="example-input2-group2" name="example-input2-group2" class="form-control" placeholder="" style="visibility:hidden" />
		        </div> 
			</div>
		</div>
