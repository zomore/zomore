        ...
        <ul class="sidebar-menu do-nicescrol">
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="${pageContext.request.contextPath}/111.html"><i class="zmdi zmdi-star-outline"></i> 商品资料</a>
                    </li>
                    <li>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="card-body" style="position: relative;">
                                                <div class="card-title text-dark">新增管理员页面
                                                    <form action="${pageContext.request.contextPath}/admin/saveHead.do" method="get">
                                                        <table>
                                                            <tr>
            ...
            <table class="table table-light table-striped shadow-light">
                ...
                <c:forEach items="${usersList}" var="head">
                    <tr>
