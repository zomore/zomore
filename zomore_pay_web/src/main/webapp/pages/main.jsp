                             ...
                             <ul class="list-unstyled">
                              <div class="title">商品</div>
                                <li><a href="${pageContext.request.contextPath}/superAdmin/findAll.do">管理员管理</a></li>
                                 <li><a href="${pageContext.request.contextPath}/superAdmin/findAllMultiple.do">连锁店管理</a></li>
...
<!--===================================================-->
                 ...
                 <div class="col-sm-8" style="margin-bottom: 10px;">
                   ...
                   <!-- Full width modal -->
                   <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">新增供应商</button>
									...
									<table id="demo-custom-toolbar"  data-toggle="table" class="table-bordered table table-hover">
										<thead>
											<tr>
												...
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">用户名</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">创建时间</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">邮箱</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">姓名</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">等级</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">地址</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">详情</th>
												<th data-field="id" data-sortable="true" data-formatter="invoiceFormatter">操作</th>
										</thead>
										
										<tbody>
                                        <c:forEach items="${userList}" var="superAdmin">
                                            <tr>
                                                <td><input name="ids" type="checkbox"></td>
                                                <td>${superAdmin.username }</td>
                                                <td>${superAdmin.createTimeStr }</td>
                                                <td>${superAdmin.mail }</td>
                                                <td>${superAdmin.phoneNumber }</td>
                                                <td>${superAdmin.name }</td>
                                                <td>${superAdmin.level }</td>
                                                <td>${superAdmin.address}</td>
                                                <td><a href="${pageContext.request.contextPath}/superAdmin/findByLevel.do?level=${superAdmin.level}" class="btn bg-olive btn-xs">详情</a></td>
                                                <td><a href="${pageContext.request.contextPath}/superAdmin/findAdminById.do?adminId=${superAdmin.adminId}" class="btn bg-olive btn-xs">修改</a></td>
                                 ...
                                 <div class="col-md-1" style="width: 1%;color: #FF0000;padding-top: 2%;">*</div>
                                  <div class="col-md-11">
                                    <div class="input-group">
                                      ...
                                      <input class="form-control" id="dataX" type="text" placeholder="">
                                    </div></br>
                                   </div> 
                                  </div>
                                <div style="border-bottom: 2px dashed #e5e5e5;"></div></br>
