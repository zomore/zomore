...
<!--===================================================-->
                 ...
                 <div class="col-sm-8" style="margin-bottom: 10px;">
                   ...
                   <!-- Full width modal -->
                   <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">新增连锁总部</button>
                      ...
                      <!-- Small modal -->
                       <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal1">高级搜索</button>
									...
									<table id="demo-custom-toolbar"  data-toggle="table" class="table-bordered table table-hover">
										...
										<tbody>
                                        <c:forEach items="${multipleList}" var="multiple">
                                            <tr>
                                                <td></td>
                                                <td>${multiple.username }</td>
                                                <td>${multiple.registrationTimeStr}</td>
                                                <td>${multiple.mail }</td>
                                                <td>${multiple.phoneNumber }</td>
                                                <td>${multiple.name }</td>
                                                <td>${multiple.address}</td>
                                                <td>${multiple.shopName}</td>
                                                <td>${multiple.industry}</td>
                                                <td>${multiple.dueTimeStr}</td>
                                                <td>${multiple.roleStr}</td>
                                                <td><a href="${pageContext.request.contextPath}/superAdmin/findShopBymultipleId.do?multipleId=${multiple.multipleId}" class="btn bg-olive btn-xs">详情</a></td>
                                                <td><a  href="${pageContext.request.contextPath}/superAdmin/findMultipleById.do?multipleId=${multiple.multipleId}" class="btn bg-olive btn-xs"<%-- data-target="#con-close-modal1"  data-toggle="modal"--%>>修改</a></td>
                                            </tr>
                                        </c:forEach>
										</tbody>
									</table>
...
<!-- 新增连锁总部弹窗 -->
<!-- ============================================================== -->
            <form action="${pageContext.request.contextPath}/superAdmin/saveMultiple.do" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="shopName" id="shopName" placeholder="请输入店铺名称">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="date" name="dueTime" id="dueTime" placeholder="请输入到期时间">
                                            </div></br>
                                            <div class="input-group">
