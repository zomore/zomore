...
<div class="sk-main">
    <div onclick="on()" class="col-lg-12 col-md-12 col-sm-12" style="text-align: center;margin-top: 13%;">
        <i class="iconfont icon-erweimacuowu" style="font-size:200px; color:#0094D9"></i></br>
        <font>支付失败了！请重新扫描支付码！</font>
        <input type="email" id="example-input2-group2" name="example-input2-group2" class="form-control" placeholder=""
