...
<!--===================================================-->
                 ...
                 <div class="col-sm-8" style="margin-bottom: 10px;">
                   ...
                   <!-- Full width modal -->
                   <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">新增单店</button>
									...
									<table id="demo-custom-toolbar"  data-toggle="table" class="table-bordered table table-hover">
                                        ...
                                        <c:forEach items="${shopList}" var="shop">
                                            <tr>
                                                <td></td>
                                                <td>${shop.username }</td>
                                                <td>${shop.registrationTimeStr}</td>
                                                <td>${shop.mail }</td>
                                                ...
                                                <td>${shop.shopName}</td>
                                                <td>${shop.industry}</td>
                                                <td>${shop.dueTimeStr}</td>
                                                <td>${shop.roleStr}</td>
                                                <td><a href="${pageContext.request.contextPath}/superAdmin/findByRole.do?role=${shop.role}" class="btn bg-olive btn-xs">详情</a></td>
                                                <td><a  href="${pageContext.request.contextPath}/superAdmin/findShopById.do?shopId=${shop.shopId}" class="btn bg-olive btn-xs"<%-- data-target="#con-close-modal1"  data-toggle="modal"--%>>修改</a></td>
                                            </tr>
                                        </c:forEach>
										</tbody>
									</table>
...
<!-- 新增连锁总部弹窗 -->
<!-- ============================================================== -->
            <form action="${pageContext.request.contextPath}/superAdmin/saveSingleShop.do" method="get">
