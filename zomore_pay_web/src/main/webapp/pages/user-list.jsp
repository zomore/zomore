        ...
        <ul class="sidebar-menu do-nicescrol">
            <li>
                <a href="${pageContext.request.contextPath}/index.html" class="waves-effect">
                    <i class="zmdi zmdi-view-dashboard"></i> <span>管理系统</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/superAdmin/saveAdmin.do" method="get">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="td_right"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>                                                                   <input type="date" name="createTime" id="createTime" placeholder="请输入创建日期"></td>
                                                            </tr>
                                                            <tr>
