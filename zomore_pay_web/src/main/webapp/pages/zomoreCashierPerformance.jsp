...
<div id="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="col-lg-12">
                    <h6 class="text-uppercase mt-3">员工角色</h6>
                    <hr>
                        ...
                        <div>
                            <form name="inputfile" action="" method="post" enctype="multipart/form-data">
                                <div style="float: left;">
                                    <a href="${basePath}zomoreCashierPerformance/addUI.do"
            ...
            <table id="example" class="table table-light table-striped shadow-light">
                ...
                <c:forEach items="${requestScope.result}" var="result">
                    <tr style="text-align: center">
                        <th scope="row">
                            <a href="${basePath}zomoreCashierPerformance/editUI.do?id=${result.zomoreCashierPerformanceId}"
                               style="color: black">编辑</a>&nbsp;
                            <a href="${basePath}zomoreCashierPerformance/deleted.do?ids=${result.zomoreCashierPerformanceId}"
                               style="color: black">删除</a>
                        </th>
                        <td>${result.zomoreCashierPerformanceId}</td>
                        <td>
                          <fmt:formatDate value="${result.zomoreCashierPerformanceDate}"  pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>
                        </td>
                        <td>${result.zomoreCashierPerformanceCashiername}</td>
                        <td>${result.zomoreCashierPerformanceCommodityname}</td>
                        <td>${result.zomoreCashierPerformanceMoney}</td>
                        <td>${result.zomoreCashierPerformanceNum}</td>
                        <td>${result.zomoreCashierPerformanceMoneyall}</td>
                        <td>${result.zomoreCashierPerformanceMoneyactual}</td>
                        <td>${result.zomoreCashierPerformanceMoneysave}</td>
                        <td>${result.zomoreCashierPerformanceType}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
