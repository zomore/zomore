...
<div id="wrapper">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="col-lg-12">
                    <h6 class="text-uppercase mt-3">收银员资料</h6>
                    <hr>
                        ...
                        <div>
                            <form name="inputfile" action="" method="post" enctype="multipart/form-data">
                                <div style="float: left;">
                                    <a href="${basePath}zomoreCashier/addUI.do"
            ...
            <table id="example" class="table table-light table-striped shadow-light">
                ...
                <c:forEach items="${requestScope.result}" var="result">
                    <tr style="text-align: center">
                        <th scope="row">
                            <a href="${basePath}zomoreCashier/editUI.do?id=${result.zomoreCommodityCategoryId}"
                               style="color: black">编辑</a>&nbsp;
                            <a href="${basePath}zomoreCashier/deleted.do?ids=${result.zomoreCommodityCategoryId}"
                               style="color: black">删除</a>
                        </th>
                        <td>${result.zomoreCommodityCategoryName}</td>
                        <td>${result.zomoreCommodityCategoryParentid}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
