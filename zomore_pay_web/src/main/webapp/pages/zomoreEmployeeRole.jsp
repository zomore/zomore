        ...
        <div class="container-fluid">
                        ...
                        <div>
                            <form name="inputfile" action="" method="post" enctype="multipart/form-data">
                                <div style="float: left;">
                                    <a href="${basePath}zomoreEmployeeRole/addUI.do"
            ...
            <table id="example" class="table table-light table-striped shadow-light">
                ...
                <c:forEach items="${requestScope.result}" var="result">
                    <tr style="text-align: center">
                        <th scope="row">
                            <a href="${basePath}zomoreEmployeeRole/editUI.do?id=${result.employeeRoleRolename}"
                               style="color: black">编辑</a>&nbsp;
                            <a href="${basePath}zomoreEmployeeRole/deleted.do?ids=${result.employeeRoleRolename}"
                               style="color: black">删除</a>
                        </th>
                        <td>${result.employeeRoleRolename}</td>
                        <td>${result.employeeRoleState=='1'?"启用":"禁用"}</td>
                        <td>${result.employeeRoleCashierStore}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
