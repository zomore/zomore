        ...
        <div class="container-fluid">
                        ...
                        <div>
                            <form name="inputfile" action="" method="post" enctype="multipart/form-data">
                                <div style="float: left;">
                                    <a href="${basePath}zomoreShoppingGuide/addUI.do"
            ...
            <table id="example" class="table table-light table-striped shadow-light">
                ...
                <tr style="text-align: center">
                    <th scope="col">操作</th>
                    <th scope="col">导购员编号</th>
                    <th scope="col">导购员姓名</th>
                    <th scope="col">手机号码</th>
                    <th scope="col">销售提成</th>
                    <th scope="col">指定提成</th>
                    <th scope="col">充值提成</th>
                    <th scope="col">次卡提成</th>
                    <th scope="col">购物卡提成</th>
                    <th scope="col">标签</th>
                    <th scope="col">是否允许领取公海会员</th>
                    <th scope="col">备注</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${requestScope.result}" var="result">
                    <tr style="text-align: center">
                        <th scope="row">
                            <a href="${basePath}zomoreShoppingGuide/editUI.do?id=${result.shoppingGuideId}"
                        ...
                        <td>${result.shoppingGuideSubcard}%</td>
                        <td>${result.shoppingGuideShoppingcar}%</td>
                        <td>${result.shoppingGuideLab}</td>
                        <td>${result.shoppingGuideIsmember=='1'?"是":"否"}</td>
