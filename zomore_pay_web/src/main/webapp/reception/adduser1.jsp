    ...
    <div class="media">
        ...
        <div class="media-body">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="memberNumber" name="memberNumber" placeholder="请输入会员卡号" value="<%=num%>" autofocus="autofocus">
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                <span class="input-group-addon"><font>&nbsp;</font>会员密码:</span>
        ...
        <div class="panel-body">
            <ul class="list-group">
                <li class="list-group-item">
                    <span class="badge badge-danger usersale">默认会员分类(无折扣)<i class="fa  fa-edit"></i></span>
                    会员分类
                </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header com-bj">
                ...
                <h4 class="modal-title" id="myModalLabel6"> 选择会员分类
                </h4>
            </div>
