...
<html>
	...
	<body>
		<header class="header com-bj">
			...
			<div class="title">调货</div>
			<div class="logo">
			</div>
	</header>
		<form action="${basePath}zomoreCommodityDiaohuo/transferCommodtyHistory.do" method="post">
		<div class="user-main" style="width: 100%; padding-left: 28%;">
			<div  style="width: 600px; margin-top: 20px;">
				<input type="hidden" name="zomoreCommodityTransferId" value="<%=id%>">
								<font style="font-size: 20px;">您正在进行商品调货</font></br>
								<font style="font-size: 16px; color: #c6c6c6;"><a style="color: #ed3030; margin-right: 5px;">*</a>确认要商品调货单据吗？如果调货请说明下原因吧！</font></br>
							   <font style="font-size: 20px;">备注：</font>
					             <div class="bz-content">
				                <textarea name="zomoreCommodityTransferMeno" placeholder="在此处输入调货备注信息！"></textarea>
			                </div>
                        </div>
		</div>
