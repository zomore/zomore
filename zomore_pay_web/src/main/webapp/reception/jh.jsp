		...
		<div class="index-footer"> 
		 ...
		 <div class="f-bottom f-bottom-bj"> 
		  <div class="col-sm-4 col-lg-3"> 
		   <div class="panel pan2"> 
		    <div class="input-group m-t-10" style="width: 100%"> 
		     <input type="email" id="searchByCode" name="example-input2-group1" class="form-control"  style="width: 90%;height: 100px;"placeholder="条码/拼音码/名称" /> <h4>扫码模式</h4>
		    </div>
		   </div> 
		  </div> 
		  <div class="col-sm-4 col-lg-3 "> 
		  ...
		  <div class="col-sm-4 col-lg-3" style="float: right;" > 
		   ...
		   <a href="javascript:void(0)" name="${basePath}reception/jinhuosk.jsp" id="getmoney">
        ...
        <script type="text/javascript">
            ...
            $('#getmoney').click(function (){
                if (parseFloat(allin).toFixed(2) > 0) {
                    var submitintogoods = ${sessionScope.zomoreCashierBeforeRight.submitintogoods}+"";
                    if (submitintogoods=='0'){
                        alert("该收银台没有提交进货的权限");
                        return false;
                    }
                    ...
                    $.ajax({
                        type: "POST",
                        url: "${basePath}zomoreCommodity/inputCommodty.do",
                        data: {
                            "name": condityname,
                            "code": conditycode,
                            "num": conditynum,
