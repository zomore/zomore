...
public class ShopController {
    ...
    public ModelAndView findAllDaily(PageResult<Dailyreport> page) throws Exception {
        ModelAndView mv = new ModelAndView();
        PageResult<Dailyreport> dailyReportList = headShopService.findAllDaily(page);
    ...
    public ModelAndView findAllReservation(PageResult<Reservation> page) throws Exception {
        ModelAndView mv = new ModelAndView();
        PageResult<Reservation> reservationList = headShopService.findAllReservation(page,session.getAttribute("shopName")+"");
